 ...
 */
public class PickLevel2 extends Fragment {
    View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        nivel1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getActivity().getApplicationContext(), Jogo2.class).putExtra("tema", 1).putExtra("nPares", 4);
                startActivity(i);
            }
        });
        ...
        nivel2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getActivity().getApplicationContext(), Jogo2.class).putExtra("tema", 2).putExtra("nPares", 6);
                startActivity(i);
            }
        });
        ...
        nivel3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //TODO modificar values a enviar
                Intent i = new Intent(getActivity().getApplicationContext(), Jogo2.class).putExtra("tema", 1).putExtra("nPares", 8);
                startActivity(i);
            }
        });
        ...
        nivel3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //TODO modificar values a enviar
                Intent i = new Intent(getActivity().getApplicationContext(), Jogo2.class).putExtra("tema", 2).putExtra("nPares", 10);
                startActivity(i);
            }
        });
        ...
        nivel4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //TODO modificar values a enviar
                Intent i = new Intent(getActivity().getApplicationContext(), Jogo2.class).putExtra("tema", 1).putExtra("nPares", 12);
                startActivity(i);
            }
        });
        ...
        nivel5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //TODO modificar values a enviar
                Intent i = new Intent(getActivity().getApplicationContext(), Jogo2.class).putExtra("tema", 2).putExtra("nPares", 15);
                startActivity(i);
            }
        });
